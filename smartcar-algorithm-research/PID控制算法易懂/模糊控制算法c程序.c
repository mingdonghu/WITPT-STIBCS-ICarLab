//由于项目需要，需要模糊控制算法，之前此类知识为0，经过半个多月的研究，
//终于有的小进展。开始想从强大的互联网上搜点c代码来研究下，结果搜遍所有搜索引擎都搜不到，
//以下本人从修改的模糊控制代码，经过自己修改后可在vc6.0，运行！
//输入e表示输出误差，ec表示误差变化率，经过测试具有很好的控制效果，对于非线性系统和数学模型难以建立的系统来说有更好的控制效果！现将其公开供大家学习研究！
#include <stdio.h>
#include"math.h" 
#define PMAX    100    
#define PMIN    -100   
