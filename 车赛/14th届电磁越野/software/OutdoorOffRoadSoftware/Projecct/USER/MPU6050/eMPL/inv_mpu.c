 ...
 * systick_delay_ms(unsigned long num_ms)
...
#define systick_delay_ms    systick_delay_ms
...
#define systick_delay_ms    msp430_systick_delay_ms
...
/* systick_delay_ms is a function already defined in ASF. */
