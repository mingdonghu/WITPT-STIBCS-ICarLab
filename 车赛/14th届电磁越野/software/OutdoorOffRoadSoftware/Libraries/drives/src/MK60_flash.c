...
// flash commands 
#define RD1BLK    0x00  // read 1 block 									// 读整块Flash
#define RD1SEC    0x01  // read 1 section									// 读整个扇区
#define PGMCHK    0x02  // program check 									// 写入检查
#define RDRSRC    0x03  // read resource 									// 读目标数据
#define PGM4      0x06  // program phase program 4 byte 	// 写入长字
#define PGM8      0x07  // program phase program 8 byte 
#define ERSBLK    0x08  // erase flash block  						// 擦除整块Flash
#define ERSSCR    0x09  // erase flash sector 						// 擦除Flash扇区
#define PGMSEC    0x0B  // program section 								// 写入扇区
#define RD1ALL    0x40  // read 1s all block 							// 读所有的块
#define RDONCE    0x41  // read once    									// 只读一次
#define PGMONCE   0x43  // program once  									// 只写一次
#define ERSALL    0x44  // erase all blocks  							// 擦除所有块
#define VFYKEY    0x45  // verift backdoor key 					 	// 验证后门访问钥匙
#define PGMPART   0x80  // program paritition 						// 写入分区
#define SETRAM    0x81  // set flexram function 					// 设定FlexRAM功能
